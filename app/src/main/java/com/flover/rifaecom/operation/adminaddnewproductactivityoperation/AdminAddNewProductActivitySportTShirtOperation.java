...
public class AdminAddNewProductActivitySportTShirtOperation implements AdminAddNewProductActivityOperation{
    private Activity adminActivity;
    private String category = "Hat";
    private String categoryRef = "category";


    public AdminAddNewProductActivitySportTShirtOperation(Activity adminActivity) {
