...
public class AdminAddNewProductActivityShoeOperation implements AdminAddNewProductActivityOperation{
    private Activity adminActivity;
    private String category = "Hat";
    private String categoryRef = "category";


    public AdminAddNewProductActivityShoeOperation(Activity adminActivity) {
