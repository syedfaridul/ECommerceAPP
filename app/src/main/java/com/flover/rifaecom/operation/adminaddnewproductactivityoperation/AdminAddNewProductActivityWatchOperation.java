...
public class AdminAddNewProductActivityWatchOperation implements AdminAddNewProductActivityOperation{
    private Activity adminActivity;
    private String category = "TShirt";
    private String categoryRef = "category";


    public AdminAddNewProductActivityWatchOperation(Activity adminActivity) {
