...
public class AdminAddNewProductActivityMobileOperation implements AdminAddNewProductActivityOperation{
    private Activity adminActivity;
    private String category = "Hat";
    private String categoryRef = "category";


    public AdminAddNewProductActivityMobileOperation(Activity adminActivity) {
