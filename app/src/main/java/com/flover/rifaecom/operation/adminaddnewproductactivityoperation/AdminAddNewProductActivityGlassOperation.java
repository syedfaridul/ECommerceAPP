...
public class AdminAddNewProductActivityGlassOperation implements AdminAddNewProductActivityOperation{
    private Activity adminActivity;
    private String category = "Glass";
    private String categoryRef = "category";


    public AdminAddNewProductActivityGlassOperation(Activity adminActivity) {
