...
public class AdminAddNewProductActivityHatOperation implements AdminAddNewProductActivityOperation{
    private Activity adminActivity;
    private String category = "Hat";
    private String categoryRef = "category";


    public AdminAddNewProductActivityHatOperation(Activity adminActivity) {
