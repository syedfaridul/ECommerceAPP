...
public class AdminAddNewProductActivityHeadPhoneOperation implements AdminAddNewProductActivityOperation{
    private Activity adminActivity;
    private String category = "Hat";
    private String categoryRef = "category";


    public AdminAddNewProductActivityHeadPhoneOperation(Activity adminActivity) {
