...
public class AdminAddNewProductActivitySweaterOperation implements AdminAddNewProductActivityOperation{
    private Activity adminActivity;
    private String category = "TShirt";
    private String categoryRef = "category";


    public AdminAddNewProductActivitySweaterOperation(Activity adminActivity) {
