...
public class AdminAddNewProductActivityPurseAndBagOperation implements AdminAddNewProductActivityOperation{
    private Activity adminActivity;
    private String category = "Hat";
    private String categoryRef = "category";


    public AdminAddNewProductActivityPurseAndBagOperation(Activity adminActivity) {
