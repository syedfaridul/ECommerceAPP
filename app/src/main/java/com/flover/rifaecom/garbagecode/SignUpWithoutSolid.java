package com.flover.rifaecom.garbagecode;
...
public class SignUpWithoutSolid extends AppCompatActivity {
                        ...
                        rootRef.child("USERS").child(validEmailId).updateChildren(userDataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    loadingBar.dismiss();
                                    Intent intent = new Intent(SignUpWithoutSolid.this, MainActivity.class);
